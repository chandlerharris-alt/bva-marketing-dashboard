...
## Git: latest commit `8860da6` (Media grid → PY/Plan/Actuals, matches OPEX). Push after each change; Cloudflare auto-rebuilds ~1-2 min. NOTE: `git pull` before pushing — Cloudflare Functions commit admin saves to main, so origin often moves ahead.
